...
#include "dbg.h"
#define DEBUG_CLD_HHDOORLOCK
#ifdef DEBUG_CLD_HHDOORLOCK
...
/***        Macro Definitions                                             ***/
/****************************************************************************/
#if defined(CLD_HH_DOORLOCK) && !defined(HH_DOORLOCK_SERVER) && !defined(HH_DOORLOCK_CLIENT)
...
PUBLIC teZCL_Status eCLD_HhDoorLockCommandHandler(
    								ZPS_tsAfEvent              *pZPSEvent,
    								tsZCL_EndPointDefinition   *psEndPointDefinition,
    								tsZCL_ClusterInstance      *psClusterInstance)
{
		tsZCL_HeaderParams sZCL_HeaderParams;
		DBG_vPrintf(TRACE_HHDOORLOCK, "\nONOFF: ");
